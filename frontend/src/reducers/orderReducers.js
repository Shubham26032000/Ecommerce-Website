import { ORDER_CREATE_FAIL, ORDER_CREATE_REQUEST, ORDER_CREATE_RESET, ORDER_CREATE_SUCCESS, ORDER_DETAILS_REQUEST, ORDER_DETAILS_SUCCESS, ORDER_LIST_FAIL, ORDER_LIST_REQUEST, ORDER_LIST_SUCCESS, ORDER_MINE_LIST_FAIL, ORDER_MINE_LIST_REQUEST, ORDER_MINE_LIST_SUCCESS, ORDER_PAY_FAIL, ORDER_PAY_REQUEST, ORDER_PAY_RESET, ORDER_PAY_SUCCESS, ORDER_UPDATE_DELIVERY_FAIL, ORDER_UPDATE_DELIVERY_REQUEST, ORDER_UPDATE_DELIVERY_SUCCESS, OREDER_DETAILS_FAIL } from "../constants/orderConstants";
...
export const updateOrderReducer = (state = { updatedOrder: [] }, action) => {
    switch (action.type) {
        ...
        case ORDER_UPDATE_DELIVERY_FAIL:
            return { loading: false, error: action.payload };
        default:
            return state;
    }
